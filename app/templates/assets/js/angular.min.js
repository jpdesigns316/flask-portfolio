...
(function(A) {
    ...
    function H(a, b) {
        ...
        return function() {
            var d = arguments[0],
                c;
            c = "[" + (a ? a + ":" : "") + d + "] http://errors.angularjs.org/1.6.0-rc.2/" + (a ? a + "/" : "") + d;
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a,
            ...
            function Ma(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    m = 0;
                    for (n = h.length; m < n;) k = t[h[m++]], c = h[m++], f = h[m++], c ? (c.scope ? (l = a.$new(), aa.$$addScopeInfo(F(k), l)) : l = a, p = c.transcludeOnThisElement ? ha(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? ha(a, b) : null, c(f, l,
                        k, d, p)) : f && f(a, k.childNodes, void 0, e)
                }
                for (var h = [], k = G(a) || a instanceof F, l, m, n, p, K, t = 0; t < a.length; t++) {
                    l = new r;
                    11 === La && Gb(a, t, k);
                    m = dc(a[t], [], l, 0 === t ? d : void 0, e);
                    (f = m.length ? U(m, a[t], l, b, c, null, [], [], f) : null) && f.scope && aa.$$addScopeClass(l.$$element);
                    l = f && f.terminal || !(n = a[t].childNodes) || !n.length ? null : Ma(n, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b);
                    if (f || l) h.push(t, f, l), p = !0, K = K || f;
                    f = null
                }
                return p ? g : null
            }
            ...
            function dc(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        W(b,
                            Ca(g), "E", d, e);
                        for (var k, l, m, n, p = a.attributes, K = 0, t = p && p.length; K < t; K++) {
                            var D = !1,
                                s = !1;
                            k = p[K];
                            l = k.name;
                            m = k.value;
                            k = Ca(l);
                            (n = Ha.test(k)) && (l = l.replace(fd, "").substr(8).replace(/_(.)/g, function(a, b) {
                                return b.toUpperCase()
                            }));
                            (k = k.match(Ka)) && X(k[1]) && (D = l, s = l.substr(0, l.length - 5) + "end", l = l.substr(0, l.length - 6));
                            k = Ca(l.toLowerCase());
                            f[k] = l;
                            if (n || !c.hasOwnProperty(k)) c[k] = m, cd(a, k) && (c[k] = !0);
                            qa(a, b, m, k, n);
                            W(b, k, "A", d, e, D, s)
                        }
            ...
            function U(a, b, d, e, f, g, h, k, l) {
                ...
                function n(a, e, f, g, l) {
                    ...
                    p = 0;
                    for (z = h.length; p < z; p++) C = h[p], ta(C, C.isolateScope ? w : e, J, g, C.require && S(C.directiveName, C.require, J, I), Qa);
                    var u = e;
                    s && (s.template || null === s.templateUrl) && (u = w);
                    a && a(u, f.childNodes, void 0, l);
                    for (p = k.length - 1; 0 <= p; p--) C = k[p], ta(C, C.isolateScope ? w : e, J, g, C.require && S(C.directiveName, C.require, J, I), Qa);
                    q(I, function(a) {
                        a = a.instance;
                ...
                l = l || {};
                for (var p = -Number.MAX_VALUE, K = l.newScopeDirective, D = l.controllerDirectives, s = l.newIsolateScopeDirective, O = l.templateDirective, C = l.nonTlbTranscludeDirective,
                    ...
                    if (v = z.transclude)
                        if (w = !0, z.$$tlb || (Z("transclusion", C, z, I), C = z), "element" === v) pa = !0, p = z.priority, V = I, I = d.$$element = F(aa.$$createComment(J, d[J])), b = I[0], ka(f, wa.call(V, 0), b), V[0].$$parentNode = V[0].parentNode, N = fc(Y, V, e, p, g && g.name, {
                    ...
                    if (z.templateUrl) P = !0, Z("template", O, z, I), O = z, z.replace && (g = z), n = ga(a.splice(A, a.length - A), I, d, f, w && N, h, k, {
                    ...
                    z.terminal && (n.terminal = !0, p = Math.max(p, z.priority))
                }
                n.scope = K && !0 === K.scope;
                n.transcludeOnThisElement = w;
                n.templateOnThisElement = P;
                n.transclude = N;
            ...
            function W(b, c, f, g, h, k, l) {
                ...
                if (e.hasOwnProperty(c)) {
                    ...
                    for (var p = 0, n = h.length; p < n; p++)
                        if (c = h[p], (x(g) || g > c.priority) && -1 !== c.restrict.indexOf(f)) {
                            k && (c = Tb(c, {
                                $$start: k,
                                $$end: l
                            }));
            ...
            function ga(a, b, d, e, g, h, k, l) {
                ...
                f(z).then(function(c) {
                    ...
                    for (n = Ma(b[0].childNodes, g); m.length;) {
                        ...
                        if (!c.$$destroyed) {
                            ...
                            D = p.transcludeOnThisElement ? ha(c, p.transclude, I) : I;
                            p(n, c, w, e, D)
                        }
                    }
                    m = null
                ...
                return function(a, b, c, d, e) {
                    a = e;
                    b.$$destroyed || (m ? m.push(b, c, d, a) : (p.transcludeOnThisElement && (a = ha(b, p.transclude,
                        e)), p(n, b, c, d, a)))
                }
            }
    ...
    eb.$$annotate = function(a, b, d) {
        ...
        } else G(a) ? (b = a.length - 1, sb(a[b], "fn"), c = a.slice(0, b)) :
            sb(a, "fn", !0);
        return c
    };
    var ae = H("$animate"),
                ...
                link: {
                    ...
                    post: function(d, h, k, l) {
                        ...
                        v ? (p.writeValue = function(a) {
                            ...
                            c ? (h[0].value !== c.selectValue && (p.removeUnknownOption(), p.unselectEmptyOption(),
                        ...
                        A && (p.emptyOption.remove(), a(p.emptyOption)(d),
            ...
            return {
                link: function(e, g, h) {
                    ...
                    e.$watch(l, function(b) {
                        ...
                        c === w || f && ga(w) || (A(), f = r[c], x(f) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m), A = v, k()) : A = e.$watch(f, k), w = c)
                    })
                }
            }
        }],
